...
# hp : 독립변수(연속형data)/ mpg : 종속변수(연속형data)

cor(mtcars$hp, mtcars$mpg) # r=-0.7761684 음의 상관관계가 강하다. 두 변수는 인과관계이다.
...
# hp, wt : 독립변수(연속형data)/ mpg : 종속변수(연속형data)
...
model2
# y = -0.03177 * new_hp + -3.87783 * new_wt + 37.22727 수식완성
